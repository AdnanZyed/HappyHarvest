...
public class FarmInput extends AppCompatActivity {
    private Spinner spinnerSoilType, spinnerIrrigationType, spinnerWaterAvailability;
    ...
    private String open_field;
    private String userValue;
    private TextView soiltype;
    private TextView spinner_hydroponic_system_TV;
    private TextView edit_nutrient_solution_TV, Type_of_organic_fertilizer, Type_of_chemical_fertilizer;
    private Spinner spinnerFertilizerType, spinner_hydroponic_system, spinner_previous_crop, spinner_organic_fertilizer, spinner_chemical_fertilizer, germination_method;
    private EditText space, edit_nutrient_solution;
    private List<Integer> selectedCropIds = new ArrayList<>();
    private TextView tvResult;
    private Spinner spinnerGreenhouseType, spinnerVentilation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, CropId + "" + farmerUserName + userValue + "", Toast.LENGTH_SHORT).show();
        ...
        if (getIntent().hasExtra("farming_method")) {
            ...
            if (open_field.equals("open_field")) {
        ...
        Spinner cropsSpinner = findViewById(R.id.spinner_previous_crop);
...
//                    }
        ...
        myViewModel.getAllCropsById(CropId).observe(this, crops1 -> {


            String previousCrop = spinner_previous_crop.getSelectedItem().toString();

            result1 = determineCompatibility(previousCrop, crops1.get(0).getPrevious_crop_preferred(),
                    crops1.get(0).getPrevious_crop_allowed(), crops1.get(0).getPrevious_crop_forbidden());
        });
...
//String locationStr,String  tempStr,String moistureStr,String acceptanceStr,String successStr ,String resultText ,String accepted) {
    ...
    private void saveEvaluationResult(int successRate, boolean isSuitable) {
        ...
        // updateUI(spinnerWaterAvailability.getSelectedItem().toString(), spinnerIrrigation.getSelectedItem().toString(), spinnerSoilType.getSelectedItem().toString(), lat, lon, currentDate, season, (float) avgHistoricalTemp, avgHistoricalHumidity, successRate, isSuitable);
