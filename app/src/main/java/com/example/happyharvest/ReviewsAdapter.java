...
public class ReviewsAdapter extends RecyclerView.Adapter<ReviewsAdapter.ReviewViewHolder> {
    ...
    private final List<Crop_Reviews> reviewsList;
    private final Context context;

    public ReviewsAdapter(Context context, List<Crop_Reviews> reviewsList) {
    ...
    public ReviewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_crops_reviwes, parent, false);
        return new ReviewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ReviewViewHolder holder, int position) {
        Crop_Reviews review = reviewsList.get(position);
