...
//
//                , "الثوم، الكراث، البصل، البطاطا، البطاطس، الفجل، اللفت، الجزر، الشمندر، الكرنب، القرنبيط، البروكلي", "حرث الأرض مرتين على الأقل بعمق 25–30 سم، حتى تهوي التربة وتتفتت الكتل.\n" +
//                "\n" +
//                "تنظيف الأرض من الحشائش والجذور اللي ممكن تعيق نمو الشتلات.\n" +
//                "\n" +
//                "إضافة السماد العضوي المتحلل (بلدي أو كمبوست) بمعدل 4–5 طن للدونم، وخلطه جيدًا بالتربة.\n" +
...
//                "\n" +
//                "شراءها من مصدر موثوق."
//                , 3, "اختر بذور بصل عالية الجودة ومعتمدة، خالية من الأمراض، وذات حجم متوسط للحصول على نمو متجانس. \uD83E\uDDC5",
